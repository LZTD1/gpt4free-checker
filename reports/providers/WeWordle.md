...
| `deepseek-reasoner` | text | ✅ `ok` | 21.23s | contains expected token 'PONG' |
| `gpt-4` | text | ✅ `ok` | 22.37s | contains expected token 'PONG' |
| `v3` | text | ✅ `ok` | 41.75s | contains expected token 'PONG' |
