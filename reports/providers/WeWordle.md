...
| `deepseek-r1` | text | ✅ `ok` | 20.47s | contains expected token 'PONG' |
...
| `gpt-4o` | text | ❌ `invalid` | 1.14s | expected 'PONG', got: 'PING' |
| `gpt-4o-mini` | text | ❌ `invalid` | 20.51s | expected 'PONG', got: 'Game' |
