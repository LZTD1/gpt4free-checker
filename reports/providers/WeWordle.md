...
| --- | --- | :---: | ---: | --- |
| `deepseek` | text | ✅ `ok` | 21.91s | contains expected token 'PONG' |
| `deepseek-r1` | text | ✅ `ok` | 22.42s | contains expected token 'PONG' |
...
| `gpt-4o` | text | ❌ `invalid` | 2.07s | expected 'PONG', got: 'PING' |
