...
| --- | --- | :---: | ---: | --- |
| `claude2` | text | ✅ `ok` | 21.02s | contains expected token 'PONG' |
...
| `claude40sonnetthinking_research` | text | ❌ `invalid` | 20.16s | expected 'PONG', got: 'est.' |
| `claude41opusthinking` | text | ❌ `invalid` | 21.03s | expected 'PONG', got: 'est.' |
| `claude45sonnet` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `claude45sonnetthinking` | text | ❌ `invalid` | 20.41s | expected 'PONG', got: 'est.' |
...
| `gpt4` | text | ❌ `invalid` | 7.93s | expected 'PONG', got: 'est.' |
...
| `grok` | text | ❌ `invalid` | 20.36s | expected 'PONG', got: 'est.' |
...
| `pplx_pro_upgraded` | text | ❌ `invalid` | 20.25s | expected 'PONG', got: 'est.' |
