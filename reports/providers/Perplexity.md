...
| `claude40opus` | text | ❌ `invalid` | 20.17s | expected 'PONG', got: 'est.' |
...
| `claude40opusthinking_labs` | text | ❌ `invalid` | 7.62s | expected 'PONG', got: 'est.' |
...
| `claude40sonnetthinking_research` | text | ❌ `invalid` | 41.10s | expected 'PONG', got: 'est.' |
...
| `experimental` | text | ❌ `invalid` | 20.36s | expected 'PONG', got: 'est.' |
...
| `gpt41` | text | ❌ `invalid` | 20.18s | expected 'PONG', got: 'est.' |
...
| `grok4` | text | ❌ `invalid` | 20.41s | expected 'PONG', got: 'est.' |
...
| `o3_research` | text | ❌ `invalid` | 41.14s | expected 'PONG', got: 'est.' |
...
| `o3pro_research` | text | ❌ `invalid` | 20.17s | expected 'PONG', got: 'est.' |
| `o4mini` | text | ❌ `invalid` | 7.83s | expected 'PONG', got: 'est.' |
