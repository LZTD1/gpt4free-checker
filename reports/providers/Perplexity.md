...
| `claude3opus` | text | ❌ `empty` | 0.24s | Empty response |
...
| `claude40opusthinking_labs` | text | ❌ `invalid` | 7.61s | expected 'PONG', got: 'est.' |
...
| `claude40sonnetthinking_labs` | text | ❌ `invalid` | 8.58s | expected 'PONG', got: 'est.' |
...
| `claude45sonnet` | text | ❌ `invalid` | 20.20s | expected 'PONG', got: 'est.' |
...
| `experimental` | text | ❌ `invalid` | 41.08s | expected 'PONG', got: 'est.' |
| `gemini` | text | ❌ `empty` | 0.44s | Empty response |
| `gemini2flash` | text | ❌ `invalid` | 20.42s | expected 'PONG', got: 'est.' |
| `gpt4` | text | ❌ `invalid` | 7.59s | expected 'PONG', got: 'est.' |
| `gpt41` | text | ❌ `invalid` | 22.00s | expected 'PONG', got: 'est.' |
...
| `o3_labs` | text | ❌ `invalid` | 20.35s | expected 'PONG', got: 'est.' |
| `o3_research` | text | ❌ `invalid` | 21.03s | expected 'PONG', got: 'est.' |
| `o3mini` | text | ❌ `invalid` | 8.09s | expected 'PONG', got: 'est.' |
...
| `pplx_reasoning` | text | ❌ `invalid` | 7.92s | expected 'PONG', got: 'est.' |
