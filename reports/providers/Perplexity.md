...
| `claude37sonnetthinking` | text | ❌ `invalid` | 41.11s | expected 'PONG', got: 'est.' |
...
| `claude40opusthinking_labs` | text | ❌ `invalid` | 7.53s | expected 'PONG', got: 'est.' |
...
| `claude41opusthinking` | text | ❌ `invalid` | 41.09s | expected 'PONG', got: 'est.' |
| `claude45sonnet` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `claude45sonnetthinking` | text | ❌ `invalid` | 20.45s | expected 'PONG', got: 'est.' |
...
| `gpt41` | text | ❌ `invalid` | 21.99s | expected 'PONG', got: 'est.' |
...
| `o3pro` | text | ❌ `invalid` | 20.50s | expected 'PONG', got: 'est.' |
| `o3pro_labs` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `o3pro_research` | text | ❌ `invalid` | 41.12s | expected 'PONG', got: 'est.' |
| `o4mini` | text | ❌ `invalid` | 7.46s | expected 'PONG', got: 'est.' |
| `pplx_alpha` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `pplx_beta` | text | ❌ `invalid` | 20.36s | expected 'PONG', got: 'est.' |
...
| `turbo` | text | ❌ `invalid` | 20.31s | expected 'PONG', got: 'est.' |
