...
| `claude2` | text | ❌ `invalid` | 20.20s | expected 'PONG', got: 'est.' |
...
| `claude40sonnetthinking_labs` | text | ❌ `invalid` | 7.60s | expected 'PONG', got: 'est.' |
| `claude40sonnetthinking_research` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `claude41opusthinking` | text | ❌ `invalid` | 20.51s | expected 'PONG', got: 'est.' |
| `claude45sonnet` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `claude45sonnetthinking` | text | ❌ `invalid` | 20.14s | expected 'PONG', got: 'est.' |
| `comet_max_assistant` | text | ❌ `invalid` | 41.13s | expected 'PONG', got: 'est.' |
...
| `gemini2flash` | text | ❌ `invalid` | 41.08s | expected 'PONG', got: 'est.' |
| `gpt4` | text | ❌ `invalid` | 7.52s | expected 'PONG', got: 'est.' |
| `gpt41` | text | ❌ `invalid` | 41.07s | expected 'PONG', got: 'est.' |
...
| `o3_research` | text | ❌ `invalid` | 41.06s | expected 'PONG', got: 'est.' |
| `o3mini` | text | ❌ `invalid` | 7.55s | expected 'PONG', got: 'est.' |
| `o3pro` | text | ❌ `invalid` | 21.03s | expected 'PONG', got: 'est.' |
| `o3pro_labs` | text | ❌ `invalid` | 7.48s | expected 'PONG', got: 'est.' |
...
| `pplx_pro_upgraded` | text | ❌ `invalid` | 20.23s | expected 'PONG', got: 'est.' |
