...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `invalid` | 20.40s | expected 'PONG', got: 'est.' |
...
| `claude40sonnetthinking_research` | text | ❌ `invalid` | 20.22s | expected 'PONG', got: 'est.' |
...
| `comet_max_assistant` | text | ❌ `invalid` | 41.30s | expected 'PONG', got: 'est.' |
...
| `gpt5_thinking` | text | ❌ `invalid` | 20.48s | expected 'PONG', got: 'est.' |
...
| `o3_research` | text | ❌ `invalid` | 20.48s | expected 'PONG', got: 'est.' |
