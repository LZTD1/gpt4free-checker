...
| `claude45sonnet` | text | ❌ `invalid` | 20.29s | expected 'PONG', got: 'est.' |
...
| `gemini2flash` | text | ❌ `invalid` | 41.14s | expected 'PONG', got: 'est.' |
...
| `gpt5_thinking` | text | ❌ `invalid` | 41.09s | expected 'PONG', got: 'est.' |
...
| `o3_research` | text | ❌ `invalid` | 20.27s | expected 'PONG', got: 'est.' |
