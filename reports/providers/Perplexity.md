...
- **Models:** 46
- **Working tests:** 1 / 46
- **Avg response time:** 5.62s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `o3mini` | text | ✅ `ok` | 5.62s | contains expected token 'PONG' |
| `auto` | text | ❌ `invalid` | 21.03s | expected 'PONG', got: 'est.' |
| `claude2` | text | ❌ `invalid` | 20.22s | expected 'PONG', got: 'est.' |
...
| `claude40opusthinking_labs` | text | ❌ `invalid` | 20.42s | expected 'PONG', got: 'est.' |
...
| `gpt41` | text | ❌ `invalid` | 20.20s | expected 'PONG', got: 'est.' |
| `gpt45` | text | ❌ `invalid` | 7.49s | expected 'PONG', got: 'est.' |
| `gpt4o` | text | ❌ `invalid` | 7.50s | expected 'PONG', got: 'est.' |
| `gpt5` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `gpt5_thinking` | text | ❌ `invalid` | 21.09s | expected 'PONG', got: 'est.' |
| `grok` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `grok4` | text | ❌ `invalid` | 20.07s | expected 'PONG', got: 'est.' |
