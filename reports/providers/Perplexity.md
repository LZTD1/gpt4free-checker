...
| `claude2` | text | ❌ `invalid` | 25.02s | expected 'PONG', got: 'est.' |
...
| `claude40sonnetthinking_labs` | text | ❌ `invalid` | 8.13s | expected 'PONG', got: 'est.' |
| `claude40sonnetthinking_research` | text | ❌ `invalid` | 21.02s | expected 'PONG', got: 'est.' |
| `claude41opusthinking` | text | ❌ `invalid` | 20.17s | expected 'PONG', got: 'est.' |
...
| `pplx_pro` | text | ❌ `invalid` | 20.16s | expected 'PONG', got: 'est.' |
