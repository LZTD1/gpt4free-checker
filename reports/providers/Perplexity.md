...
| `claude40opus` | text | ❌ `invalid` | 20.30s | expected 'PONG', got: 'est.' |
...
| `claude41opusthinking` | text | ❌ `invalid` | 22.42s | expected 'PONG', got: 'est.' |
| `claude45sonnet` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `claude45sonnetthinking` | text | ❌ `invalid` | 20.30s | expected 'PONG', got: 'est.' |
| `comet_max_assistant` | text | ❌ `invalid` | 41.10s | expected 'PONG', got: 'est.' |
...
| `gpt41` | text | ❌ `invalid` | 22.05s | expected 'PONG', got: 'est.' |
...
| `grok` | text | ❌ `invalid` | 20.50s | expected 'PONG', got: 'est.' |
...
| `pplx_reasoning` | text | ❌ `invalid` | 7.88s | expected 'PONG', got: 'est.' |
