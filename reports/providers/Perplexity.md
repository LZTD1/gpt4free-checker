...
| `claude40opus` | text | ❌ `invalid` | 20.33s | expected 'PONG', got: 'est.' |
...
| `claude41opusthinking` | text | ❌ `invalid` | 20.35s | expected 'PONG', got: 'est.' |
...
| `o1` | text | ❌ `empty` | 0.32s | Empty response |
...
| `pplx_beta` | text | ❌ `invalid` | 20.47s | expected 'PONG', got: 'est.' |
| `pplx_pro` | text | ❌ `invalid` | 21.02s | expected 'PONG', got: 'est.' |
| `pplx_pro_upgraded` | text | ❌ `invalid` | 41.09s | expected 'PONG', got: 'est.' |
