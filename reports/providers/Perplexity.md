...
- **Models:** 46
- **Working tests:** 1 / 46
- **Avg response time:** 20.33s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `o3pro_research` | text | ✅ `ok` | 20.33s | contains expected token 'PONG' |
...
| `claude40sonnetthinking_research` | text | ❌ `invalid` | 20.40s | expected 'PONG', got: 'est.' |
| `claude41opusthinking` | text | ❌ `invalid` | 20.29s | expected 'PONG', got: 'est.' |
...
| `gemini` | text | ❌ `empty` | 0.23s | Empty response |
...
| `gpt45` | text | ❌ `invalid` | 7.78s | expected 'PONG', got: 'est.' |
| `gpt4o` | text | ❌ `invalid` | 7.95s | expected 'PONG', got: 'est.' |
| `gpt5` | text | ❌ `invalid` | 21.03s | expected 'PONG', got: 'est.' |
| `gpt5_thinking` | text | ❌ `invalid` | 21.03s | expected 'PONG', got: 'est.' |
| `grok` | text | ❌ `invalid` | 20.25s | expected 'PONG', got: 'est.' |
...
| `o3` | text | ❌ `invalid` | 41.18s | expected 'PONG', got: 'est.' |
...
| `o4mini` | text | ❌ `invalid` | 7.64s | expected 'PONG', got: 'est.' |
...
| `turbo` | text | ❌ `invalid` | 20.33s | expected 'PONG', got: 'est.' |
