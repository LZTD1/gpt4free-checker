...
| `claude2` | text | ❌ `invalid` | 20.30s | expected 'PONG', got: 'est.' |
...
| `claude40opus` | text | ❌ `invalid` | 20.41s | expected 'PONG', got: 'est.' |
...
| `claude40opusthinking_labs` | text | ❌ `invalid` | 20.12s | expected 'PONG', got: 'est.' |
| `claude40opusthinking_research` | text | ❌ `invalid` | 22.03s | expected 'PONG', got: 'est.' |
| `claude40sonnet_research` | text | ❌ `invalid` | 20.17s | expected 'PONG', got: 'est.' |
...
| `claude45sonnetthinking` | text | ❌ `invalid` | 20.33s | expected 'PONG', got: 'est.' |
...
| `o3` | text | ❌ `invalid` | 20.49s | expected 'PONG', got: 'est.' |
