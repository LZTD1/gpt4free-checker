...
| `claude2` | text | ❌ `invalid` | 20.32s | expected 'PONG', got: 'est.' |
...
| `o4mini` | text | ❌ `invalid` | 7.52s | expected 'PONG', got: 'est.' |
...
| `pplx_pro_upgraded` | text | ❌ `invalid` | 20.07s | expected 'PONG', got: 'est.' |
