...
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.83s | contains expected token 'PONG' |
...
| `gemini-3.5-flash` | text | ✅ `ok` | 20.53s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 21.88s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.56s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 42.45s | NoMediaResponseError: No media response from Gemini |
