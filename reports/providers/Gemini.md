...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.47s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 20.27s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 20.69s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 20.25s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 2.12s | contains expected token 'PONG' |
