...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.09s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 20.21s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 21.60s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.31s | contains expected token 'PONG' |
...
| `gemini-flash-lite` | text | ✅ `ok` | 20.22s | contains expected token 'PONG' |
