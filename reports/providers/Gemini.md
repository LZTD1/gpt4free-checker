...
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.29s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 20.89s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 1.90s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 22.21s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 1.93s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 1.91s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 21.77s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.16s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 21.82s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 20.24s | NoMediaResponseError: No media response from Gemini |
