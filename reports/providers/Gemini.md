...
| `gemini-2.0-flash` | text | ✅ `ok` | 1.72s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 21.82s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.38s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 1.74s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 20.41s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 41.06s | contains expected token 'PONG' |
