...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 14.15s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 1.75s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 2.10s | contains expected token 'PONG' |
...
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 1.35s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 21.84s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 1.69s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.68s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 20.37s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 1.76s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 0.92s | NoMediaResponseError: No media response from Gemini |
