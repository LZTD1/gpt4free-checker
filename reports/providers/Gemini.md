...
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 21.09s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 1.81s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 21.54s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 20.27s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 20.30s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.17s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.49s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 41.44s | contains expected token 'PONG' |
