...
| `gemini-2.0-flash` | text | ✅ `ok` | 20.62s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.38s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 2.16s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 21.66s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 1.78s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.51s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 22.13s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 20.42s | contains expected token 'PONG' |
