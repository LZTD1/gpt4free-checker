...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 20.96s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.44s | contains expected token 'PONG' |
...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.30s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 20.60s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 20.49s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 22.45s | contains expected token 'PONG' |
...
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.45s | contains expected token 'PONG' |
