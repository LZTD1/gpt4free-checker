...
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.17s | contains expected token 'PONG' |
...
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 20.32s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 20.23s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 1.96s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 41.05s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.53s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 20.48s | NoMediaResponseError: No media response from Gemini |
