...
| `gemini-2.0-flash` | text | ✅ `ok` | 20.73s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 20.30s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 20.11s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 21.02s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 1.84s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 20.42s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 2.05s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.81s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 1.68s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 1.75s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 20.35s | NoMediaResponseError: No media response from Gemini |
