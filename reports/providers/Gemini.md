...
| `gemini-2.0-flash` | text | ✅ `ok` | 1.77s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 21.53s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 20.20s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 2.17s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.57s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 1.96s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 22.35s | contains expected token 'PONG' |
