...
| `gemini-2.0-flash` | text | ✅ `ok` | 20.18s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 20.09s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 20.16s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 41.67s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 20.34s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 2.20s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 2.20s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 1.98s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 1.87s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 21.06s | NoMediaResponseError: No media response from Gemini |
