...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.32s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 20.66s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 20.23s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 2.07s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 20.48s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 1.88s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 22.06s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 20.69s | contains expected token 'PONG' |
