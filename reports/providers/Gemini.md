...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 23.06s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 22.21s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 41.07s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 21.95s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.56s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 21.38s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 20.09s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 22.04s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 20.13s | NoMediaResponseError: No media response from Gemini |
