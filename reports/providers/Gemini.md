...
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.39s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 1.74s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 21.69s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 20.52s | contains expected token 'PONG' |
