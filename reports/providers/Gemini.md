...
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.08s | contains expected token 'PONG' |
...
| `gemini-3.5-flash` | text | ✅ `ok` | 2.22s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.54s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 1.96s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.35s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.07s | contains expected token 'PONG' |
