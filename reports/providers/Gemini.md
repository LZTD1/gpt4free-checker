...
| `gemini-2.0-flash` | text | ✅ `ok` | 20.47s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 21.95s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 20.37s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 44.24s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 21.79s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 21.02s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 1.94s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 21.64s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 20.14s | contains expected token 'PONG' |
