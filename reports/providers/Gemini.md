...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 14.10s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.53s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 1.88s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 1.98s | contains expected token 'PONG' |
...
| `gemini-3.5-flash` | text | ✅ `ok` | 2.20s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 21.99s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.20s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 21.04s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.30s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 1.94s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 1.95s | contains expected token 'PONG' |
