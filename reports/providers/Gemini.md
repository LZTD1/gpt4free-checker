...
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.13s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 1.47s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 1.34s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 1.81s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 2.21s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 20.31s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 1.02s | NoMediaResponseError: No media response from Gemini |
