...
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 21.56s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.51s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.51s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 20.13s | contains expected token 'PONG' |
