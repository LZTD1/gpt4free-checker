...
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.94s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.54s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 2.51s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 2.71s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 20.30s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 21.86s | contains expected token 'PONG' |
...
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.68s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 1.96s | contains expected token 'PONG' |
