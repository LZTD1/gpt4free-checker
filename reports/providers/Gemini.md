...
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 1.90s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 22.05s | contains expected token 'PONG' |
...
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 21.53s | contains expected token 'PONG' |
