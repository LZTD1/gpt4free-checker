...
| `gemini-2.0-flash` | text | ✅ `ok` | 21.57s | contains expected token 'PONG' |
...
| `gemini-3.5-flash` | image | ❌ `exception` | 20.22s | NoMediaResponseError: No media response from Gemini |
