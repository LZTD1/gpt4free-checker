...
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.37s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.45s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 1.83s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.30s | contains expected token 'PONG' |
...
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 21.97s | contains expected token 'PONG' |
