...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 18.30s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 21.04s | contains expected token 'PONG' |
...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.46s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 1.88s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 22.41s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.58s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 1.72s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 20.17s | contains expected token 'PONG' |
