...
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.12s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 20.28s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 21.02s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.46s | contains expected token 'PONG' |
