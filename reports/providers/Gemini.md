...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.29s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 1.83s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 2.02s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.16s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.23s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 21.07s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 2.01s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 20.10s | NoMediaResponseError: No media response from Gemini |
