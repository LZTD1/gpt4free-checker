...
| `gemini-2.0-flash` | text | ✅ `ok` | 20.32s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 21.44s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.17s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 43.05s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 21.68s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 43.37s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.10s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 44.33s | contains expected token 'PONG' |
