...
| `gemini-2.0-flash` | text | ✅ `ok` | 21.92s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 21.61s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.02s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 2.04s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 20.42s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 22.06s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 21.95s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.43s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 21.02s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 20.99s | contains expected token 'PONG' |
