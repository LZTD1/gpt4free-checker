...
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 21.97s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 1.84s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 21.66s | contains expected token 'PONG' |
...
| `gemini-3.5-flash` | text | ✅ `ok` | 21.68s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 20.47s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 20.61s | contains expected token 'PONG' |
