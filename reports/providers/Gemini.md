...
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.50s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 21.89s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 22.04s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 20.17s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.69s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 22.51s | contains expected token 'PONG' |
