...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 21.13s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.11s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 22.06s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 21.95s | contains expected token 'PONG' |
...
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.28s | contains expected token 'PONG' |
