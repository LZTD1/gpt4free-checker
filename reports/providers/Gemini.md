...
- **Models:** 13
- **Working tests:** 4 / 13
- **Avg response time:** 15.97s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.27s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 20.91s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 2.52s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 20.17s | contains expected token 'PONG' |
