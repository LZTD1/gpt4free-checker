...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 18.31s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.59s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 1.97s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 1.90s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 20.45s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.02s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 20.07s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 22.06s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.10s | contains expected token 'PONG' |
...
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 22.14s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 20.67s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 21.36s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 20.09s | NoMediaResponseError: No media response from Gemini |
