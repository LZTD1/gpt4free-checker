...
| `gemini-2.0-flash` | text | ✅ `ok` | 1.64s | contains expected token 'PONG' |
...
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 22.44s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 21.60s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.07s | contains expected token 'PONG' |
...
| `gemini-flash-lite` | text | ✅ `ok` | 22.41s | contains expected token 'PONG' |
