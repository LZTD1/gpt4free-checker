...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.26s | contains expected token 'PONG' |
...
| `gemini-3.5-flash` | text | ✅ `ok` | 20.09s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 1.96s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 21.83s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.21s | contains expected token 'PONG' |
