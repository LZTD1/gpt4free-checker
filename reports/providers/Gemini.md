...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 19.96s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 41.04s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 2.23s | contains expected token 'PONG' |
...
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 1.87s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 20.57s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.08s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 22.11s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 20.53s | NoMediaResponseError: No media response from Gemini |
