...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 18.09s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.19s | contains expected token 'PONG' |
...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.40s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 21.01s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 1.97s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 1.74s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.45s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.20s | contains expected token 'PONG' |
