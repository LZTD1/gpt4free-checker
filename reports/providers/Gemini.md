...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 19.71s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.32s | contains expected token 'PONG' |
...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 2.34s | contains expected token 'PONG' |
...
| `gemini-3.5-flash` | text | ✅ `ok` | 20.77s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.21s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 20.19s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 20.66s | contains expected token 'PONG' |
