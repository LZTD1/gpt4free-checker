...
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.14s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 22.02s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 20.06s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 1.88s | contains expected token 'PONG' |
...
| `gemini-flash-lite` | text | ✅ `ok` | 21.97s | contains expected token 'PONG' |
