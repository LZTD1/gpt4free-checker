...
- **Models:** 17
- **Working tests:** 14 / 17
- **Avg response time:** 20.01s

## Per-model results

| Model | Capability | Status | Time | Notes |
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.08s | contains expected token 'PONG' |
...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 1.84s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 22.10s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.47s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 22.10s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 22.06s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 22.06s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 20.23s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 22.06s | contains expected token 'PONG' |
