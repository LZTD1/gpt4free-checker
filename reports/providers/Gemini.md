...
| --- | --- | :---: | ---: | --- |
| `gemini-2.0` | text | ✅ `ok` | 20.58s | contains expected token 'PONG' |
| `gemini-2.0-flash` | text | ✅ `ok` | 2.24s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 2.23s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.92s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.22s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 1.92s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 20.21s | contains expected token 'PONG' |
...
| `gemini-3.6-flash` | image | ❌ `exception` | 20.49s | NoMediaResponseError: No media response from Gemini |
