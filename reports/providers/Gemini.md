...
| `gemini-3.5-flash` | text | ✅ `ok` | 22.02s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 20.40s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 21.02s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 22.02s | contains expected token 'PONG' |
