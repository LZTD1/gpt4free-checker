...
| `gemini-2.0-flash` | text | ✅ `ok` | 20.08s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 20.52s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 20.23s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 1.97s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 20.23s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 22.06s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 22.02s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 1.92s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 21.83s | contains expected token 'PONG' |
