...
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.07s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.83s | contains expected token 'PONG' |
...
| `gemini-3.5-flash` | text | ✅ `ok` | 20.29s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 20.26s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 20.92s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.17s | contains expected token 'PONG' |
