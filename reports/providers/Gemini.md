...
| `gemini-2.0-flash` | text | ✅ `ok` | 1.91s | contains expected token 'PONG' |
...
| `gemini-2.5-flash` | text | ✅ `ok` | 20.18s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 21.25s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 20.23s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 22.07s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 20.78s | contains expected token 'PONG' |
