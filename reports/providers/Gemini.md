...
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 21.74s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 22.02s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.59s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 22.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 2.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite-thinking` | text | ✅ `ok` | 1.92s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 1.97s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.26s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 20.18s | contains expected token 'PONG' |
