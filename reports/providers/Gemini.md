...
| `gemini-2.0-flash` | text | ✅ `ok` | 20.21s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 20.31s | contains expected token 'PONG' |
...
| `gemini-auto` | text | ✅ `ok` | 20.27s | contains expected token 'PONG' |
