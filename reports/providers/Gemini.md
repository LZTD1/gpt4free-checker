...
| `gemini-2.0-flash` | text | ✅ `ok` | 1.92s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-2.0-flash-thinking-with-apps` | text | ✅ `ok` | 20.33s | contains expected token 'PONG' |
| `gemini-2.5-flash` | text | ✅ `ok` | 20.16s | contains expected token 'PONG' |
| `gemini-3.1-flash-lite` | text | ✅ `ok` | 21.03s | contains expected token 'PONG' |
| `gemini-3.5-flash` | text | ✅ `ok` | 21.74s | contains expected token 'PONG' |
| `gemini-3.5-flash-lite` | text | ✅ `ok` | 20.45s | contains expected token 'PONG' |
...
| `gemini-3.5-flash-thinking-lite` | text | ✅ `ok` | 22.15s | contains expected token 'PONG' |
| `gemini-3.6-flash-thinking` | text | ✅ `ok` | 20.82s | contains expected token 'PONG' |
| `gemini-auto` | text | ✅ `ok` | 1.93s | contains expected token 'PONG' |
| `gemini-flash-lite` | text | ✅ `ok` | 4.09s | contains expected token 'PONG' |
