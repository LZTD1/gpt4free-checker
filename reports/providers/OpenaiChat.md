...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `timeout` | 64.57s | Timeout limit exceeded |
| `gpt-4` | text | ❌ `timeout` | 63.45s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 65.01s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 64.90s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o-mini` | text | ❌ `timeout` | 64.73s | Timeout limit exceeded |
| `gpt-5` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-5-1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-5-2` | text | ❌ `timeout` | 64.66s | Timeout limit exceeded |
...
| `o3-mini-high` | text | ❌ `timeout` | 64.71s | Timeout limit exceeded |
| `o4-mini` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o4-mini-high` | text | ❌ `timeout` | 64.58s | Timeout limit exceeded |
