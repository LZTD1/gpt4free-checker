...
| `gpt-4` | text | ❌ `timeout` | 63.49s | Timeout limit exceeded |
...
| `o3-mini` | text | ❌ `timeout` | 64.87s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 64.67s | Timeout limit exceeded |
| `o4-mini` | text | ❌ `timeout` | 64.78s | Timeout limit exceeded |
| `o4-mini-high` | text | ❌ `timeout` | 64.99s | Timeout limit exceeded |
