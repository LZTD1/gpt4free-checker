...
| `gpt-4` | text | ❌ `timeout` | 64.80s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 64.99s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o` | text | ❌ `timeout` | 64.99s | Timeout limit exceeded |
| `gpt-4o-mini` | text | ❌ `timeout` | 63.36s | Timeout limit exceeded |
| `gpt-5` | text | ❌ `timeout` | 63.39s | Timeout limit exceeded |
| `gpt-5-1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-5-2` | text | ❌ `timeout` | 45.54s | Timeout limit exceeded |
...
| `o3-mini` | text | ❌ `timeout` | 63.22s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 64.77s | Timeout limit exceeded |
