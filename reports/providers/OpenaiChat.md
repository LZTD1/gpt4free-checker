...
| `gpt-4` | text | ❌ `timeout` | 63.42s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 63.09s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 64.63s | Timeout limit exceeded |
...
| `gpt-image` | image | ❌ `timeout` | 64.69s | Timeout limit exceeded |
| `o1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o1-mini` | text | ❌ `timeout` | 64.59s | Timeout limit exceeded |
| `o3-mini` | text | ❌ `timeout` | 64.65s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 63.54s | Timeout limit exceeded |
