...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `timeout` | 64.87s | Timeout limit exceeded |
| `gpt-4` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 64.71s | Timeout limit exceeded |
