...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `timeout` | 64.71s | Timeout limit exceeded |
| `gpt-4` | text | ❌ `timeout` | 64.63s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 63.10s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `timeout` | 64.92s | Timeout limit exceeded |
...
| `gpt-5-1` | text | ❌ `timeout` | 64.76s | Timeout limit exceeded |
...
| `o1-mini` | text | ❌ `timeout` | 64.86s | Timeout limit exceeded |
| `o3-mini` | text | ❌ `timeout` | 64.83s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o4-mini` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o4-mini-high` | text | ❌ `timeout` | 64.63s | Timeout limit exceeded |
