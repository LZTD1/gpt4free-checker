...
| `gpt-4.5` | text | ❌ `timeout` | 64.91s | Timeout limit exceeded |
| `gpt-4o` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o-mini` | text | ❌ `timeout` | 64.61s | Timeout limit exceeded |
| `gpt-5` | text | ❌ `timeout` | 63.45s | Timeout limit exceeded |
| `gpt-5-1` | text | ❌ `timeout` | 64.93s | Timeout limit exceeded |
| `gpt-5-2` | text | ❌ `timeout` | 64.73s | Timeout limit exceeded |
...
| `o3-mini-high` | text | ❌ `timeout` | 63.31s | Timeout limit exceeded |
| `o4-mini` | text | ❌ `timeout` | 64.81s | Timeout limit exceeded |
