...
| `gpt-4` | text | ❌ `timeout` | 64.92s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 63.08s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 64.93s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o` | text | ❌ `timeout` | 64.88s | Timeout limit exceeded |
...
| `gpt-image` | image | ❌ `timeout` | 63.13s | Timeout limit exceeded |
