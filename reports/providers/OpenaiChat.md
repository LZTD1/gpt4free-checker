...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `timeout` | 64.62s | Timeout limit exceeded |
| `gpt-4` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 63.19s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `timeout` | 47.14s | Timeout limit exceeded |
| `gpt-4o` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o-mini` | text | ❌ `timeout` | 64.65s | Timeout limit exceeded |
| `gpt-5` | text | ❌ `timeout` | 64.57s | Timeout limit exceeded |
...
| `o4-mini` | text | ❌ `timeout` | 63.43s | Timeout limit exceeded |
