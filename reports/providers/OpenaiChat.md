...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `timeout` | 64.75s | Timeout limit exceeded |
...
| `gpt-4o` | text | ❌ `timeout` | 64.67s | Timeout limit exceeded |
...
| `o3-mini-high` | text | ❌ `timeout` | 64.57s | Timeout limit exceeded |
