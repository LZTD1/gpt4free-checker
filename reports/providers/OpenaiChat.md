...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `timeout` | 64.98s | Timeout limit exceeded |
...
| `gpt-4o` | text | ❌ `timeout` | 64.72s | Timeout limit exceeded |
| `gpt-4o-mini` | text | ❌ `timeout` | 65.00s | Timeout limit exceeded |
| `gpt-5` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-5-1` | text | ❌ `timeout` | 63.17s | Timeout limit exceeded |
