...
| `gpt-4` | text | ❌ `timeout` | 63.35s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 64.59s | Timeout limit exceeded |
...
| `gpt-image` | image | ❌ `timeout` | 64.89s | Timeout limit exceeded |
| `o1` | text | ❌ `timeout` | 64.93s | Timeout limit exceeded |
| `o1-mini` | text | ❌ `timeout` | 64.99s | Timeout limit exceeded |
| `o3-mini` | text | ❌ `exception` | 44.75s | Exception: 
                ---------------------
...
| `o4-mini-high` | text | ❌ `exception` | 23.28s | Exception: 
                ---------------------
                Failed to connect to browser
                ---------------------
                One of the  |
