...
| `gpt-4` | text | ❌ `timeout` | 65.01s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 64.63s | Timeout limit exceeded |
...
| `gpt-5-1` | text | ❌ `timeout` | 63.25s | Timeout limit exceeded |
| `gpt-5-2` | text | ❌ `timeout` | 63.57s | Timeout limit exceeded |
