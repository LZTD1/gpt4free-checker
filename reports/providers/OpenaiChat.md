...
| `gpt-4.1-mini` | text | ❌ `timeout` | 65.00s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `timeout` | 63.24s | Timeout limit exceeded |
...
| `gpt-image` | image | ❌ `timeout` | 64.61s | Timeout limit exceeded |
| `o1` | text | ❌ `timeout` | 64.62s | Timeout limit exceeded |
| `o1-mini` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o3-mini` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 64.73s | Timeout limit exceeded |
