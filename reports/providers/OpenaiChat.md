...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `timeout` | 64.80s | Timeout limit exceeded |
| `gpt-4` | text | ❌ `timeout` | 63.36s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 63.25s | Timeout limit exceeded |
...
| `gpt-5-2` | text | ❌ `timeout` | 64.95s | Timeout limit exceeded |
...
| `o3-mini` | text | ❌ `timeout` | 64.63s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o4-mini` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o4-mini-high` | text | ❌ `timeout` | 64.75s | Timeout limit exceeded |
