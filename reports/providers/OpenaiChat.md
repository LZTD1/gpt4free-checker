...
| `gpt-4o-mini` | text | ❌ `timeout` | 64.77s | Timeout limit exceeded |
...
| `o3-mini` | text | ❌ `timeout` | 64.79s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 47.04s | Timeout limit exceeded |
