...
| `gpt-4o` | text | ❌ `exception` | 44.60s | Exception: 
                ---------------------
...
| `gpt-image` | image | ❌ `timeout` | 63.51s | Timeout limit exceeded |
| `o1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o1-mini` | text | ❌ `exception` | 42.86s | Exception: 
                ---------------------
                Failed to connect to browser
                ---------------------
                One of the  |
...
| `o4-mini` | text | ❌ `exception` | 44.71s | Exception: 
                ---------------------
                Failed to connect to browser
                ---------------------
                One of the  |
| `o4-mini-high` | text | ❌ `timeout` | 64.59s | Timeout limit exceeded |
