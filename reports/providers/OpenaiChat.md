...
| `gpt-4.1-mini` | text | ❌ `exception` | 43.20s | Exception: 
                ---------------------
...
| `o4-mini` | text | ❌ `timeout` | 64.58s | Timeout limit exceeded |
| `o4-mini-high` | text | ❌ `timeout` | 64.87s | Timeout limit exceeded |
