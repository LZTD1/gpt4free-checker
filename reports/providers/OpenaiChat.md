...
| `gpt-4` | text | ❌ `timeout` | 63.46s | Timeout limit exceeded |
| `gpt-4.1` | text | ❌ `timeout` | 64.90s | Timeout limit exceeded |
| `gpt-4.1-mini` | text | ❌ `timeout` | 64.63s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `exception` | 43.80s | Exception: 
                ---------------------
                Failed to connect to browser
                ---------------------
                One of the  |
| `gpt-4o` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o-mini` | text | ❌ `timeout` | 64.64s | Timeout limit exceeded |
| `gpt-5` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-5-1` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-5-2` | text | ❌ `timeout` | 63.17s | Timeout limit exceeded |
...
| `o3-mini` | text | ❌ `timeout` | 63.43s | Timeout limit exceeded |
