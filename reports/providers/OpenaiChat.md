...
| `gpt-5-1` | text | ❌ `timeout` | 47.04s | Timeout limit exceeded |
| `gpt-5-2` | text | ❌ `timeout` | 64.92s | Timeout limit exceeded |
| `gpt-image` | image | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o1` | text | ❌ `timeout` | 64.90s | Timeout limit exceeded |
| `o1-mini` | text | ❌ `timeout` | 64.76s | Timeout limit exceeded |
| `o3-mini` | text | ❌ `timeout` | 64.70s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o4-mini` | text | ❌ `timeout` | 63.23s | Timeout limit exceeded |
