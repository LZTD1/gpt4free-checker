...
| `gpt-4.1-mini` | text | ❌ `timeout` | 63.39s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o` | text | ❌ `timeout` | 64.57s | Timeout limit exceeded |
| `gpt-4o-mini` | text | ❌ `timeout` | 63.31s | Timeout limit exceeded |
...
| `o4-mini-high` | text | ❌ `timeout` | 64.73s | Timeout limit exceeded |
