...
| --- | --- | :---: | ---: | --- |
| `auto` | text | ❌ `timeout` | 64.69s | Timeout limit exceeded |
| `gpt-4` | text | ❌ `timeout` | 64.87s | Timeout limit exceeded |
...
| `o1` | text | ❌ `timeout` | 64.92s | Timeout limit exceeded |
| `o1-mini` | text | ❌ `timeout` | 64.69s | Timeout limit exceeded |
| `o3-mini` | text | ❌ `timeout` | 64.80s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o4-mini` | text | ❌ `timeout` | 64.65s | Timeout limit exceeded |
