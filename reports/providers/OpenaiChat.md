...
| `gpt-4.1-mini` | text | ❌ `timeout` | 64.70s | Timeout limit exceeded |
...
| `gpt-5-2` | text | ❌ `timeout` | 51.64s | Timeout limit exceeded |
...
| `o3-mini` | text | ❌ `timeout` | 64.64s | Timeout limit exceeded |
| `o3-mini-high` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `o4-mini` | text | ❌ `timeout` | 64.77s | Timeout limit exceeded |
| `o4-mini-high` | text | ❌ `timeout` | 63.42s | Timeout limit exceeded |
