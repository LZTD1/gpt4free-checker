...
| `gpt-4.1` | text | ❌ `exception` | 43.22s | Exception: 
                ---------------------
                Failed to connect to browser
                ---------------------
                One of the  |
| `gpt-4.1-mini` | text | ❌ `timeout` | 64.87s | Timeout limit exceeded |
| `gpt-4.5` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-4o` | text | ❌ `exception` | 43.83s | Exception: 
                ---------------------
                Failed to connect to browser
                ---------------------
                One of the  |
...
| `gpt-5-1-instant` | text | ❌ `exception` | 43.30s | Exception: 
                ---------------------
                Failed to connect to browser
                ---------------------
                One of the  |
| `gpt-5-1-thinking` | text | ❌ `timeout` | 64.97s | Timeout limit exceeded |
| `gpt-5-2` | text | ❌ `timeout` | 64.76s | Timeout limit exceeded |
| `gpt-5-2-instant` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-5-2-thinking` | text | ❌ `timeout` | 45.00s | Timeout limit exceeded |
| `gpt-5-instant` | text | ❌ `exception` | 43.80s | Exception: 
                ---------------------
                Failed to connect to browser
                ---------------------
                One of the  |
