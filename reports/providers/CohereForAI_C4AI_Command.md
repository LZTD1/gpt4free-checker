...
| `command-r-plus-08-2024` | text | ✅ `ok` | 0.99s | contains expected token 'PONG' |
| `command-r7b-12-2024` | text | ✅ `ok` | 43.04s | contains expected token 'PONG' |
| `command-r7b-arabic-02-2025` | text | ✅ `ok` | 0.32s | contains expected token 'PONG' |
| `command-r` | text | ❌ `empty` | 0.34s | Empty response |
