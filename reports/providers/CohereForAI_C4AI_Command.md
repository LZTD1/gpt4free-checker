...
| `command-r7b-12-2024` | text | ✅ `ok` | 0.40s | contains expected token 'PONG' |
| `command-r7b-arabic-02-2025` | text | ✅ `ok` | 23.22s | contains expected token 'PONG' |
| `command-r` | text | ❌ `empty` | 0.23s | Empty response |
| `command-r-08-2024` | text | ❌ `invalid` | 0.89s | expected 'PONG', got: 'Ping' |
