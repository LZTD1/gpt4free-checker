...
| `command-r7b-arabic-02-2025` | text | ✅ `ok` | 1.50s | contains expected token 'PONG' |
| `command-a-03-2025` | text | ❌ `invalid` | 1.86s | expected 'PONG', got: 'PING' |
| `command-r` | text | ❌ `empty` | 0.41s | Empty response |
| `command-r-08-2024` | text | ❌ `invalid` | 0.34s | expected 'PONG', got: 'Ping' |
| `command-r-plus` | text | ❌ `empty` | 0.73s | Empty response |
