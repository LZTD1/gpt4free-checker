...
| `command-a-03-2025` | text | ❌ `invalid` | 0.28s | expected 'PONG', got: 'PING' |
| `command-r` | text | ❌ `empty` | 0.60s | Empty response |
| `command-r-08-2024` | text | ❌ `invalid` | 0.75s | expected 'PONG', got: 'Ping' |
| `command-r-plus` | text | ❌ `empty` | 0.30s | Empty response |
